...
enum ScreenshotAndBanner_t : uint8_t {
	...
	// Official GAME_EVENT tail; declared for parity, nothing produces them yet.
	SCREENSHOT_AND_BANNER_TYPE_LEADER_MONSTER_KILLED = 14,
	SCREENSHOT_AND_BANNER_TYPE_SUBAREA_UNLOCKED = 15,
	SCREENSHOT_AND_BANNER_TYPE_AREA_UNLOCKED = 16
};
